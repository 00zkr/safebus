...
async function resetDemoData() {
  ...
  try {
    ...
    await connection.query('DELETE FROM parent_notifications');
    ...
    await connection.query('ALTER TABLE parent_notifications AUTO_INCREMENT = 1');
    await connection.query('ALTER TABLE students AUTO_INCREMENT = 1');
    await connection.query('ALTER TABLE routes AUTO_INCREMENT = 1');
    await connection.query('ALTER TABLE buses AUTO_INCREMENT = 1');
    ...
    await connection.query('ALTER TABLE buses AUTO_INCREMENT = 5');
    await connection.query('ALTER TABLE routes AUTO_INCREMENT = 5');
    await connection.query('ALTER TABLE students AUTO_INCREMENT = 9');
    await connection.query('ALTER TABLE parent_notifications AUTO_INCREMENT = 8');

    await connection.commit();
    emitRealtime('demo:reset', { message: 'Demo data reset' });
